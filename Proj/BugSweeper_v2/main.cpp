    ...
    do {    
        for (int count=1;count<=6;count++) {
            //Checking A row
                    ...
                    else if (count!=clrdA1||count!=clrdA2||count!=clrdA3||count!=clrdA4||count!=clrdA5||count!=clrdA6) {
                        cout<<"X ";
                        if (count%6==0)
                            cout<<endl;
                    }
        ...
        for (int count=1;count<=6;count++){
                    ...
                    else if (count!=clrdB1||count!=clrdB2||count!=clrdB3||count!=clrdB4||count!=clrdB5||count!=clrdB6) {
                        cout<<"X ";
                        if (count%6==0)
                            cout<<endl;
                    }
        ...
        for (int count=1;count<=6;count++){
                    ...
                    else if (count!=clrdC1||count!=clrdC2||count!=clrdC3||count!=clrdC4||count!=clrdC5||count!=clrdC6) {
                        cout<<"X ";
                        if (count%6==0)
                            cout<<endl;
                    }
        ...
        for (int count=1;count<=6;count++){
                    ...
                    else if (count!=clrdD1||count!=clrdD2||count!=clrdD3||count!=clrdD4||count!=clrdD5||count!=clrdD6) {
                        cout<<"X ";
                        if (count%6==0)
                            cout<<endl;
                    }
